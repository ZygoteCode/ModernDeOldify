...
namespace ColorfulSoft.DeOldify
{
    ...
    internal static unsafe class DeOldifyStable
    {
...
#else
#if stable
            byte[] myByteArray = System.IO.File.ReadAllBytes("models\\stable.model");
            var stream = File.Open("models\\stable.model", FileMode.Open);
            var br = new BinaryReader(stream);
#else
            byte[] myByteArray = System.IO.File.ReadAllBytes("models\\deoldify_colorization\\artistic.model");
            var stream = File.Open("models\\deoldify_colorization\\artistic.model", FileMode.Open);
            var br = new BinaryReader(stream);
#endif
#endif
