...
namespace ColorfulSoft.DeOldify
{
    ...
    internal static unsafe class DeOldifyArtistic
    {
...
#else
#if stable
            byte[] myByteArray = System.IO.File.ReadAllBytes("models\\deoldify_colorization\\stable.model");
            var stream = File.Open("models\\deoldify_colorization\\stable.model", FileMode.Open);
            var br = new BinaryReader(stream);
#else
            byte[] myByteArray = System.IO.File.ReadAllBytes("models\\artistic.model");
            var stream = File.Open("models\\artistic.model", FileMode.Open);
            var br = new BinaryReader(stream);
#endif
#endif
